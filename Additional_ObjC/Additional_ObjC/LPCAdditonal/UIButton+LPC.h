...
/**
 ...
 @return UIButton
 */
+ (instancetype)LPC_ButtonWithTitle:(NSString *)title fontSize:(CGFloat)fontSize normalColor:(UIColor *)normalColor selectedColor:(UIColor *)selectedColor Target:(id)target Action:(SEL)action;
...
/**
 ...
 @return 图片Button
 */
+ (instancetype)LPC_ButtonWithNormalImage:(NSString *)normalImage selectedImage:(NSString *)selectedImage Target:(id)target Action:(SEL)action;
 ...
 */
+ (instancetype)LPC_ButtonWithTitle:(NSString *)NormalTitle SelectTitle:(NSString *)selectTitle normalColor:(UIColor *)normalColor selectedColor:(UIColor *)selectedColor Target:(id)target Action:(SEL)action;
